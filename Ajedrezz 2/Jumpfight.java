 ...
 */
public class Jumpfight extends World {
    ...
    public Jumpfight() {    
        ...
        addObject(new Buffon(1), 0, 1);
        addObject(new Buffon(1), 7, 1);
        addObject(new Buffon(1), 3, 1);
        addObject(new Buffon(1), 4, 1);
        
        addObject(new Caballo(1), 0, 0);
        addObject(new Caballo(1), 6, 0);
        addObject(new Caballo(1), 2, 0);
        addObject(new Caballo(1), 4, 0);

        addObject(new Buffon(-1), 0, 6);
        addObject(new Buffon(-1), 7, 6);
        addObject(new Buffon(-1), 3, 6);
        addObject(new Buffon(-1), 4, 6);
        
        addObject(new Caballo(-1), 1, 7);
        addObject(new Caballo(-1), 7, 7);
        addObject(new Caballo(-1), 3, 7);
        addObject(new Caballo(-1), 5, 7);
